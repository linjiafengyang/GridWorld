 ...
 */
public class Jigsaw {
	private JigsawNode beginJNode;		// 拼图的起始状态节点
	private JigsawNode endJNode;		// 拼图的目标状态节点
	private JigsawNode currentJNode;	// 拼图的当前状态节点
	...
	public boolean BFSearch() throws IOException {
		...
		while (!this.openList.isEmpty()) {
			...
			// (2-3)寻找所有与currentJNode邻接且未曾被访问的节点，将它们插入到openList中
